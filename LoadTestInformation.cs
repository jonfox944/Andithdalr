...
public class LoadTestInformation : MonoBehaviour
{
	...
	void Start ()
	{
		...
		//Debug.Log ("Player Class :" + GameInformation.PlayerClass.ClassName);
		//Debug.Log ("Player Description :" + GameInformation.PlayerClass.ClassDescription);
